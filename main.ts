...
Deno.serve(async (req) => {
  ...
  // SECURITY & ADMIN CHECK (Accessing /admin page is still protected)
  ...
  // --- API: SHOP & ADMIN DATA (TEMPORARILY PUBLIC FOR DEBUGGING) ---
  ...
  // ... (REST OF THE API LOGIC UNCHANGED FOR BREVITY) ...
